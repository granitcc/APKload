        ...
        <div>
         ...
         <div className="alll">
             ...
             <div className="logo"><img src={android} /></div>
                  ...
                  <button className="btn">Download v4.17.14(14.4mb)</button> </div>
                  <div className="link">
...
<input class="input-field ip"  type="password" placeholder="Confirm Password" name="confirm"  />
                         ...
                         <input type="checkbox" name="check" value="checked"/>
                          ...
                          <span id="rm">   Remeber Me</span> </span>
                         <p href="/" id="botttom">Forgot password?</p>
                         </div>
                         <button className="button"><span id="tt">L O G </span><span id="ttt">I N</span></button>
                         <div className="bootom">
                             <p id="singupp">Don't have an account?</p>
                             <p  id="singup">
                               
                           <NavLink activeClassName="active" to="/singup"><span id="ll">SING UP</span></NavLink>
                            <Switch>
                                <Route path="/singup" />
