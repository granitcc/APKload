...
function GamesDetailPage() {
        ...
        <div className="review-1">
          ...
          <span className="review-name">
            ...
            <div className="review-star">
              <span className="stari">
                <svg
                  ...
                  width="16.859"
                  height="16.137"
                  viewBox="0 0 16.859 16.137"
                >
                  <path
                    id="Icon_awesome-star"
                    data-name="Icon awesome-star"
                    d="M8.967.56,6.909,4.733,2.3,5.4a1.009,1.009,0,0,0-.558,1.721L5.078,10.37,4.29,14.955a1.008,1.008,0,0,0,1.462,1.062l4.119-2.165,4.119,2.165a1.009,1.009,0,0,0,1.462-1.062l-.788-4.585L18,7.125A1.009,1.009,0,0,0,17.437,5.4l-4.6-.671L10.775.56A1.009,1.009,0,0,0,8.967.56Z"
                ...
                <span className="rew-1">
                  ...
                  >
                    <g
                      id="Group_817"
                      data-name="Group 817"
                      transform="translate(-812 -2731)"
                    >
                      <text
                        id="_15"
                        data-name="15"
                        transform="translate(816 2770)"
                        fill="#707070"
                        font-size="12"
                  ...
                  >
                    ...
                    >
                      <path
                        id="Path_646"
                        data-name="Path 646"
                        d="M6.7,12.375H4.6a3.4,3.4,0,0,1-.1-1.125h0a3.4,3.4,0,0,1,.1-1.125H6.7a3.4,3.4,0,0,1,.1,1.125h0A3.4,3.4,0,0,1,6.7,12.375Z"
                        fill="#707070"
                      />
                      <path
                        id="Path_647"
                        data-name="Path 647"
                        d="M6.7,19.125H4.6A3.4,3.4,0,0,1,4.5,18h0a3.4,3.4,0,0,1,.1-1.125H6.7A3.4,3.4,0,0,1,6.8,18h0A3.4,3.4,0,0,1,6.7,19.125Z"
                        fill="#707070"
                      />
                      <path
                        id="Path_648"
                        data-name="Path 648"
                        d="M6.7,25.875H4.6a3.4,3.4,0,0,1-.1-1.125h0a3.4,3.4,0,0,1,.1-1.125H6.7a3.4,3.4,0,0,1,.1,1.125h0A3.4,3.4,0,0,1,6.7,25.875Z"
                        fill="#707070"
                      />
                    </g>
                  </svg>
            ...
            <span className="review-content">
              <p id="content-rew">
                Wonderful Game!The jewels are very nicely desgined, and shaped
                in a very desirable way so tha it can be played easily.Please
                develop more games like this one.
              </p>
            </span>
          </span>
        </div>
  ...
  const extraContentt = (
    <div>
      <p className="extra-content">
        -Explore thre Season of content Set yourself for an epic adventure
        ...
        <div className="gamesdetail-left">
          <div className="gamesdetail-left-first">
            ...
            <div className="gamesdetail-left-first-content">
              ...
              <p className="update">
                Version: <span className="updatecolor">32.1.0 </span>
                <span className="grayupdate"> for Android</span>
              </p>

              <p className="update">
                Category:{" "}
                <span className="updatecolor">
                  Puzzle,Game,Action,Adventure
                </span>
              </p>
              ...
              <p className="update">
                Size:
                <span className="grayupdate">100MB </span>
              </p>
              <p className="update">
                Installs:
                <span className="grayupdate">5000+</span>
              </p>
              <div className="main-first-right-end">
                <span className="ccolor">
                  <svg
                    ...
                    width="22.28"
                    height="35.97"
                    viewBox="0 0 22.28 35.97"
                  >
                    <path
                      id="Icon_metro-bookmark"
                      data-name="Icon metro-bookmark"
                      d="M8.355,1.928V32.777l9.64-9.64,9.64,9.64V1.928Z"
                      transform="translate(-6.855 -0.428)"
                      fill="none"
                      stroke="#1bb0dc"
                      stroke-width="3"
                    />
                ...
                <button className="wishlist-button">DOWNLOAD</button>{" "}
              </div>
            </div>
          </div>
          ...
          <div className="gamesdetail-left-description">
            ...
            <div className="gamesdetail-left-description-readmoreless">
              <p>
                Empires & Puzzles is a completely new take on match-3-puzzel
                games, combinig RPG elements, raids and building a migtycastel
                -topped wiith epic PCP duels.Start your fantasy adventure today!
                <br />
                -Slove Match 3 Puzzles <br />
                Send your army to the victory by matching colorful shields and
                creating epic combos! <br />
                <br />
              </p>
            ...
            <div className="games-detail-update">
              ...
              <p className="second-text">
                -Ninja Tower Event is approchaing -prepare to climb to the top!
                <br />
                -Updated Return to Morlovia Even is here -preapre for new
                challenges in late octomber!
                <br />
          ...
          <div className="previous-version">
            <div className="box">
                  ...
                  >
                    ...
                    >
                      <path
                        id="Union_1"
                        data-name="Union 1"
                        d="M14,0l5,5.5L14,11Zm0,11H0L4.373,5.5,0,0H14V11Z"
              ...
              <div className="box-info">
                ...
                <p className="box-info-date">2020-09-23</p>
              </div>
                ...
                <button className="btnsvg">
                  ...
                  >
                    <path
                      ...
                      d="M23.437,12A11.437,11.437,0,1,1,12,.563,11.436,11.436,0,0,1,23.437,12ZM9.971,6.65V12H6.7a.554.554,0,0,0-.392.945l5.3,5.271s.563.217.779,0l5.3-5.271A.553.553,0,0,0,17.294,12H14.029V6.65a.555.555,0,0,0-.553-.553H10.524A.555.555,0,0,0,9.971,6.65Z"
              ...
              <div className="game-detail-reviews-end">
                <div className="review-1">
                  ...
                  <span className="review-name">
                    ...
                    <span className="review-content">
                      <p id="content-rew">
                        Wonderful Game!The jewels are very nicely desgined, and
                        shaped in a very desirable way so tha it can be played
                        easily.Please develop more games like this one.
                      </p>
                    </span>
                  </span>
                </div>
          ...
          <div className="gamesdetail-download">
            <div className="gamesdetail-download-flex-row">
              ...
              <div className="download-elements">
                ...
                <span className="download-nameless">
                  Faster, free and saving data!
                </span>
              </div>
            </div>
            <button className="download-button">
              Download c3.17.14(14.4MB)
            </button>
          </div>
          <div className="under ">
            <div className="hheed">
