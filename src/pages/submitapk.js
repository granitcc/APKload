    ...
    <>
      ...
      <div className="submit-apk">
        <div className="left">
          ...
          <p id="p">
            {" "}
            Every apk file is manaually reviews by the APKoad team before being
            posted to the site.Your name may be shown pupblicaly.
          </p>
          <p id="pp">
            {" "}
            After you've signed for a APKload account, you can upload apps to
            APKloadusing your Developer Console. update and distribute app to
            all APKload user.
          </p>
        </div>
            ...
            <form>
              ...
              <div className="data2">
                <div className="elementt">
                  <label for="package" className="enem">
                    Package Name
                  </label>
                  <div class="input-container">
                    <i class="far fa-th icon"></i>
                    <input
              ...
              <div className="btt">
                <button className="bt" value="submit">
                  <span id="tt">S U B M I T</span>
                  <span id="ttt">P A C K A G E</span>
                </button>
              </div>
