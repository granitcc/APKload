...
function SingupPage() {
    ...
    return (
        ...
        <div className="alll">
             ...
             <div className="logo"><img src={android} /></div>
                  <div className="texkt">
                  ...
                  <p id="ppp">Discover top apps and games and get recommentations you will love.</p>
                  </div>
                  <div className="two">
                  ...
                  <p id="pp">Access all of your apps,get app updates in one place</p>
                  </div>
...
<input  class="input-field ip"  type="name" placeholder="Enter your first name" name="name" />
                             </div></div>
                             <div className="pwd2">
                             <label for="confirmname">Last Name</label>
                             <div class="input-container">
                             <i class="fas fa-user icon"></i>
<input class="input-field ip"  type="name" placeholder="Enter tour last name" name="confirm"  />
...
<input class="input-field ip"  type="password" placeholder="Confirm Password" name="confirm"  />
                         ...
                         <input type="checkbox" name="check" value="checked"/>
                          <span id="rm"> Agree with our <span id="blue">Privacy policy</span> and <span id="blue">Terms</span></span> </span>
   
                         </div>

                         <button className="button"   ><span id="tt">S I G N</span><span id="ttt">U P</span></button>
                         <div className="bootom">
                             <p id="singupp">Already have an account?</p>
                             <p  id="singup">
                               
                           <NavLink activeClassName="active" to="/signin"><span id="ll">LOG IN</span></NavLink>
                            <Switch>
                                <Route path="/singup" />
