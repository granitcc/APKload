      ...
      <div className="apkloadapp">
        ...
        <div className="second">
          <div className="secondfirst">
            ...
            <p className="he">
              {" "}
              With APKload, you can instantly download and update refion locked
              (not available in your contry),
            </p>
            <p className="he">
              pre-registred games and many other Apps on Android.
            </p>
          </div>
          ...
          <div className="secondicon">
            <div className="secondiconcontent">
              ...
              <p className="ggg1">
                Apkload offers a selection of the best Android games and apps
                which you can not even find the in Playstore search result.No
                region lock worries.Download and play now for free
              </p>
            </div>
            ...
            <div className="secondiconcontent">
              ...
              <p className="ggg1">
                All Apps in the APKload are safe for your Android phone to
                download.They have to pass a signature verification check before
        ...
        <div className="third">
          <div className="thirdcontent">
            ...
            <div className="rigt">
              ...
              <p className="texttx">
                Get the best games with our editors and users recomandations
                every day. You'll never miss any fresh out and trending Android
                games.
              </p>
        ...
        <div className="fourth">
          <div className="thirdcontentt">
            ...
            <div className="rigti">
              ...
              <p className="textttx">
                Share geeky,fun things in our community fun with hashtags,
                stories and more new features in APKload App version 3.0. Find
                Andorid geeks like you and connect with them.
              </p>
        ...
        <div className="fifth">
          <div className="fifthcontent">
            ...
            <div className="goright">
              ...
              <p className="textttx">
                Install any free Android game APK files with a single click. We
                make them stay up to date all the time.As soon as APKload is
                installed,you have nothing to worry.
              </p>
              <button className="button">Download v3.17.14(14.4MB)</button>
            </div>
          </div>
        ...
        <div className="rewivs">
          <div className="rewivs1">
            ...
            <span className="star">
              <svg
                ...
                width="14.168"
                height="12.854"
                viewBox="0 0 14.168 12.854"
              >
                <path
                  id="Icon_awesome-star"
                  data-name="Icon awesome-star"
                  d="M7.765.446,6.036,3.77,2.167,4.3A.793.793,0,0,0,1.7,5.675L4.5,8.26l-.662,3.652a.838.838,0,0,0,1.229.846l3.461-1.724,3.461,1.724a.839.839,0,0,0,1.229-.846L12.553,8.26l2.8-2.585A.793.793,0,0,0,14.883,4.3L11.014,3.77,9.285.446A.869.869,0,0,0,7.765.446Z"
          ...
          <div className="all-rewi">
            {" "}
            <div className="rewivs2">
              <div className="reww">
                <img src={man1} />
            ...
            <p id="there">
              There is something so great about this app because it has many
              updates and the games always do update on the latest version with
              the update button.
            </p>
            <span id="theeree">
              <svg
                ...
                width="137.534"
                height="16.048"
                viewBox="0 0 137.534 16.048"
              >
                <g
                  id="Group_591"
                  data-name="Group 591"
                  transform="translate(-495.832 -3666.124)"
                >
                  <text
                    id="_3"
                    data-name="3"
                    transform="translate(517.63 3678.124)"
                    fill="#b2b2b2"
                    font-size="11"
                  ...
                  <text
                    id="_9"
                    data-name="9"
                    transform="translate(562.498 3678.124)"
                    fill="#b2b2b2"
                    font-size="11"
                    font-family="OpenSans-Light, Open Sans"
                    font-weight="300"
                  ...
                  <text
                    id="Reply"
                    transform="translate(608.365 3677.124)"
                    fill="#b2b2b2"
                    font-size="10"
                    font-family="OpenSans-Light, Open Sans"
                    font-weight="300"
                  ...
                  <path
                    ...
                    d="M11.15,19.456,9.969,18.38C5.771,14.574,3,12.064,3,8.983A4.439,4.439,0,0,1,7.483,4.5,4.881,4.881,0,0,1,11.15,6.2a4.881,4.881,0,0,1,3.668-1.7A4.439,4.439,0,0,1,19.3,8.983c0,3.081-2.771,5.591-6.969,9.406Z"
                    transform="translate(492.832 3662.312)"
                    fill="#b2b2b2"
                  />
                  <path
                    id="Icon_ionic-ios-text"
                    data-name="Icon ionic-ios-text"
                    d="M11.7,4.5c-4.6,0-8.32,3.008-8.32,6.72,0,2.6,1.824,4.848,4.492,5.968a5.228,5.228,0,0,1-1.34,2.42.159.159,0,0,0,.144.252,6.436,6.436,0,0,0,2.04-.508,6.312,6.312,0,0,0,1.852-1.476,10.648,10.648,0,0,0,1.14.064c4.6,0,8.32-3.008,8.32-6.72S16.291,4.5,11.7,4.5Z"
                    transform="translate(536.804 3662.312)"
                    fill="#b2b2b2"
                  />
                  <path
                    id="Icon_material-reply"
                    data-name="Icon material-reply"
                    d="M11.668,11.6V7.5L4.5,14.668l7.168,7.168v-4.2c5.12,0,8.7,1.638,11.264,5.222C21.908,17.74,18.836,12.62,11.668,11.6Z"
                    transform="translate(579.94 3659.312)"
                    fill="#b2b2b2"
                  />
                </g>
              </svg>
          ...
          <div className="all-rewii">
            ...
            <div className="rewivs2">
              <div className="reww">
                ...
                <span className="rewwtext">
                  <p id="theree">
                    <span id="name">Mian Kamushi</span>
                  </p>
                  <p id="theree">
                    <span id="date">29 Agust 2018</span>
                  </p>
                </span>
              </div>
              <span className="star">
            ...
            <p id="there">
              There is something so grat about this app because it has many
              updates and the games always do update on the latest version with
              the update button.
            </p>
            <span id="theeree">
          ...
          <div className="all-rewii">
            ...
            <div class="endcomments">
              ...
              <p>That good to hear!We are glad that you are happy</p>
            </div>
          </div>
        </div>
      </div>
