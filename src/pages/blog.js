        ...
        <div className="left-blog">
          ...
          <div className="left-blog-content">
            <div className="contentone">
              <div className="imgcont">
                {" "}
                <img src={blog1} id="contentone" />
              </div>
              <span className="gamedesc">
                <img src={blog1a} className="littel" />
                Game descibtion
              </span>
            </div>
            <div className="contentone">
              <div className="imgcont">
                {" "}
                <img src={blog2} id="contentone" />
              </div>
              <span className="gamedesc">
                <img src={blog2a} className="littel" />
                Game descibtion
              </span>
            </div>
          </div>
          <div className="left-blog-content">
            <div className="contentone">
              <div className="imgcont">
                {" "}
                <img src={blog3} id="contentone" />
              </div>
              <span className="gamedesc">
                <img src={blog3a} className="littel" />
                Game descibtion
              </span>
            </div>
            <div className="contentone">
              <div className="imgcont">
                {" "}
                <img src={blog4} id="contentone" />
              </div>
              <span className="gamedesc">
                <img src={blog4a} className="littel" />
                Game descibtion
              </span>
            </div>
          </div>
          <div className="left-blog-content">
            <div className="contentone">
              <div className="imgcont">
                {" "}
                <img src={blog5} id="contentone" />
              </div>
              <span className="gamedesc">
                <img src={blog8a} className="littel" />
                Game descibtion
              </span>
            </div>
            <div className="contentone">
              <div className="imgcont">
                {" "}
                <img src={blog6} id="contentone" />
              </div>
              <span className="gamedesc">
                <img src={blog6a} className="littel" />
                Game descibtion
              </span>
            </div>
          </div>
          <div className="left-blog-content">
            <div className="contentone">
              <div className="imgcont">
                {" "}
                <img src={blog7} id="contentone" />
              </div>
              <span className="gamedesc">
                <img src={blog7a} className="littel" />
                Game descibtion
              </span>
            </div>
            <div className="contentone">
