      ...
      <div className="allinone">
        ...
        <div className="twoinone">
          <div className="download">
            <div className="texte">
              <span className="and">
                <img src={adnroidblue} width="100px" id="immgmg" />
              </span>
              <span className="roid">
                APKLoad
                <span id="star">
            ...
            <button className="buuton">Download v3.17.14(14.4MB)</button>
          </div>
          ...
          <div className="icon_wrapper">
            <div className="icon">
              ...
              <img src={facebook} alt="" className="icc" />
            </div>
            <div className="icon">
              {" "}
              <svg>
              ...
              <img src={twwiter} alt="" className="icc" />
            </div>
            <div className="icon">
              {" "}
              <svg>
              ...
              <img src={pinterest} alt="" className="icc" />
            </div>
            <div className="icon">
              {" "}
              <svg>
              ...
              <img src={reddit} alt="" className="icc" />
            </div>
            <div className="icon">
              {" "}
              <svg>
              ...
              <img src={iinn} alt="" className="icc" />
            </div>
            <div className="icon">
              {" "}
              <svg>
              ...
              <img src={youtube} alt="" className="icc" />
            </div>
            <div className="icon" id="heki">
              {" "}
              <svg>
                <rect rx="50" ry="50"></rect>
              </svg>
              <img src={instagram} alt="" className="icc" id="heki" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="main lefty">
            ...
            <div className="item4">
              ...
              <article className="card--widee">
                ...
                <div className="card__content">
                  <header className="card__header">
                    <h2 className="card__titlee">
                      Empires & Puzzels: Epic Matchs{" "}
                    </h2>
                    <div className="card__subtitlee">
                      By Dashlane <br />
            ...
            <div className="item33">
              ...
              <div class="flex">
                <ul className="padd">
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g cool-link"> Adventure</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                  ...
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Game</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Travel</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Personalizition</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Productivity</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Video</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Simulation</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Music</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Card</span>
                  </li>
                  <br />
                </ul>
                <ul className="padd">
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Entairment</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Action</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Acrade</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                  ...
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Busnis</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Sports</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Chat</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g"> Netflix</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Racing</span>
                  </li>
                  <br />
                  <li>
                    {" "}
                    <img src={empires} className="h" />
                    <span className="g  cool-link"> Puzzel</span>
                  </li>
                  <br />
                </ul>
              </div>
